...
Route::get('/products/descending', [ProductController::class, 'descending']);
Route::get('/products/ascending', [ProductController::class, 'ascending']);
Route::get('/products/reset', [ProductController::class, 'reset']);